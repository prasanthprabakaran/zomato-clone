...
const tabs = [
  ...
  },
  {
    id: 1,
    name: "Nightlife",
    active_img: "//b.zmtcdn.com/data/o2_assets/855687dc64a5e06d737dae45b7f6a13b1616149818.png",
    backdrop: "##EDf4FF",
...
const TabOptions = ({ activeTab, setActiveTab }) => {
  return (
    <div className='tab-container'>
      <div className='tab-container-wrapper max-width'>
        {tabs.map((tab) => (
          <div className={`tab-item absolute-center cur-po 
